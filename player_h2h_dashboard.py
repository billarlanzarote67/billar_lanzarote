...
def api_h2h():
    try:
        ...
        if not pa or not pb:
            return jsonify({
                "status": "error",
                "message": "One or both players were not found."
            }), 404
        ...
        result = {
            ...
            "note": "This H2H view currently compares stored player summary stats. Match-by-match H2H can be added later."
        }
